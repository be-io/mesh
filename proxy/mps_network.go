...
// @MPI("mesh.net.index")
func (that *meshPRSINetworkMPS) Index(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
// @MPI("mesh.net.instx")
func (that *meshPRSINetworkMPS) Instx(ctx context.Context, index *types.Paging) (*types.Page, error) {
