...
func (that *network) Index(ctx context.Context, index *types.Paging) (*types.Page, error) {
	return TR(ctx, func(ctx context.Context, ss *badgerhold.Store) (*types.Page, error) {
...
func (that *network) Instx(ctx context.Context, index *types.Paging) (*types.Page, error) {
	return nil, nil
}
