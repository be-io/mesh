...
class ServiceInfo {
    ...
    public proto: string = "";
    public codec: string = "";
    public asyncable: boolean = false;
...
const formatLegacyName = (name: string): string => {
    switch (name) {
        case "edge-asset":
        case "asset":
            return "asset"
            ...
            registrations.forEach(registration => {
                ...
                ss.forEach(ms => {
                    infos.push({
                        ...
                        app: formatLegacyName(registration.name),
                        ...
                        <TableBody>
                            {resources.map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell size="small" align="left">{row.asyncable ? '异步' : '同步'}</TableCell>
