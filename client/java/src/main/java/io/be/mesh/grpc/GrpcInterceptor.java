...
public class GrpcInterceptor implements ServerInterceptor, ClientInterceptor {
    ...
    public <I, O> ClientCall<I, O> interceptCall(MethodDescriptor<I, O> descriptor, CallOptions options, Channel channel) {
        ...
        setMetadata(metadata, GrpcContextKey.OUTGOING_HOST, io.be.mesh.prsim.Context.Metadata.MESH_INCOMING_HOST.get());
        setMetadata(metadata, GrpcContextKey.INCOMING_PROXY, io.be.mesh.prsim.Context.Metadata.MESH_INCOMING_PROXY.get());
        setMetadata(metadata, GrpcContextKey.OUTGOING_PROXY, io.be.mesh.prsim.Context.Metadata.MESH_OUTGOING_PROXY.get());
        setMetadata(metadata, GrpcContextKey.MESH_URN, Mesh.context().getUrn());
        setMetadata(metadata, GrpcContextKey.SUBSET, io.be.mesh.prsim.Context.Metadata.MESH_SUBSET.get());
        setMetadata(metadata, GrpcContextKey.VERSION, io.be.mesh.prsim.Context.Metadata.MESH_VERSION.get());
        setMetadata(metadata, GrpcContextKey.TIMESTAMP, io.be.mesh.prsim.Context.Metadata.MESH_TIMESTAMP.get());
        setMetadata(metadata, GrpcContextKey.RUN_MODE, io.be.mesh.prsim.Context.Metadata.MESH_RUN_MODE.get());
        // INC
        setMetadata(metadata, GrpcContextKey.TECH_PROVIDER_CODE, io.be.mesh.prsim.Context.Metadata.MESH_TECH_PROVIDER_CODE.get());
        setMetadata(metadata, GrpcContextKey.TOKEN, io.be.mesh.prsim.Context.Metadata.MESH_TOKEN.get());
        setMetadata(metadata, GrpcContextKey.TARGET_NODE_ID, io.be.mesh.prsim.Context.Metadata.MESH_TARGET_NODE_ID.get());
        setMetadata(metadata, GrpcContextKey.TARGET_INST_ID, io.be.mesh.prsim.Context.Metadata.MESH_TARGET_INST_ID.get());
        setMetadata(metadata, GrpcContextKey.SESSION_ID, io.be.mesh.prsim.Context.Metadata.MESH_SESSION_ID.get());
