 ...
 *
 */
package io.be.mesh.crypt;

import io.be.mesh.cause.CryptException;
...
public final class Crypts {
     ...
     * @return 填充好签名的加密报文
     */
    public static String pse(Mapper mapper, String privateKey, String publicKey, io.be.mesh.mpc.Codec codec) {
     ...
     * @return 原始报文
     */
    public static <T> T dvs(String data, String publicKey, String privateKey, io.be.mesh.mpc.Codec codec, Types<T> type) {
     ...
     * @return true通过
     */
    public static boolean verify(String data, io.be.mesh.mpc.Codec codec, String publicKey) {
