...
import io.be.mesh.mpc.Runmode;
import io.be.mesh.mpc.Types;
import io.be.mesh.struct.Location;
...
public interface Context extends Serializable {
    ...
    /**
     * Mesh resource uniform name. Like: create.tenant.omega.json.http2.000.lx000001.ducesoft.com
     *
     * @return Uniform name.
     */
    String getUrn();
