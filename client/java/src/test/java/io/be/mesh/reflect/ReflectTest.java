...
public class ReflectTest {
    ...
    public void javacTest() throws Throwable {
        ...
        new JdkCompiler().doCompile("com.jiumi.mesh.reflect.ReflectTest$ITest$X3Input", Tool.read(getClass().getResourceAsStream("/Test.javac")));
