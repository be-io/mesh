...
import io.be.mesh.mpc.URN;
import io.be.mesh.mpc.URNFlag;
...
public class URNTest {
    ...
    public void urnConflictTest() {
        ...
        Assert.assertEquals(urn.toString(), "accessible.edge.network.omega.com.0000000102030000000012700000001104123.lx000000000000000000x.ducesoft.com");
    ...
    public void urnParseTest() {
        ...
        URN urn = URN.from("accessible.edge.network.omega.com.0000000102030000000012700000001104123.lx000000000000000000x.ducesoft.com");
    ...
    public void urnParseBindingTest() {
        URN urn = URN.from("com.0000000102030000000012700000001104123.lx000000000000000000x.ducesoft.com");
