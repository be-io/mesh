...
// @MPI("mesh.net.index")
func (that *meshNetworkMPI) Index(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
// @MPI("mesh.net.instx")
func (that *meshNetworkMPI) Instx(ctx context.Context, index *types.Paging) (*types.Page, error) {
