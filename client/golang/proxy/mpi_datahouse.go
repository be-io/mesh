...
// Read
// @MPI("mesh.dh.read")
func (that *meshDataHouseMPI) Read(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
// Indies
// @MPI("mesh.dh.indies")
func (that *meshDataHouseMPI) Indies(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
// Tables
// @MPI("mesh.dh.tables")
func (that *meshDataHouseMPI) Tables(ctx context.Context, index *types.Paging) (*types.Page, error) {
