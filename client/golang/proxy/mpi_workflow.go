...
func (that *meshWorkflowMPI) Groups(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
func (that *meshWorkflowMPI) Index(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
func (that *meshWorkflowMPI) Routines(ctx context.Context, index *types.Paging) (*types.Page, error) {
