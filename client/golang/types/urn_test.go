...
func TestURNParse(t *testing.T) {
	...
	name := "accessible.edge.network.omega.com.0000000102030000000012700000000104123.%s.ducesoft.com"
	...
	releaseProduct := FromURN(ctx, "releaseProduct.server.base.0001100000000000000000000000000000080.lx0000010000010.ducesoft.com")
	t.Log(releaseProduct.MatchNode(ctx, "LX0000010000010"))
	t.Log(releaseProduct.MatchInst(ctx, "JG0100000100000000"))

	if len(FromURN(ctx, "releaseProduct.server.base.000110000000000000000000000.lx0000010000010.ducesoft.com").Flag.String()) != 37 {
		t.Error("Not compatible")
	}

	if len(FromURN(ctx, "releaseProduct.server.base.000110000000000000000000000000000008000.lx0000010000010.ducesoft.com").Flag.String()) != 37 {
		t.Error("Not compatible")
	}
	FromURN(ctx, "list.repository.data.asset.0001100000000000000012700000000139426.jg0100000500000000.ducesoft.com")
}
