...
func (that *systemNetwork) Index(ctx context.Context, index *types.Paging) (*types.Page, error) {
...
func (that *systemNetwork) Instx(ctx context.Context, index *types.Paging) (*types.Page, error) {
